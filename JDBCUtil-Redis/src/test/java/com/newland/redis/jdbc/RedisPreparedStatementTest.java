...
public class RedisPreparedStatementTest {
    ...
    public void insertInto() throws Exception {
        ...
        redisPreparedStatement.setString(2, "S0400220190813240000598989609");
    ...
    public void select() throws Exception {
        String sql = "select task_template_id,file_name,source_machine,source_path,check_file_path,data_index,file_status from fjbi_busdatacollect_list where task_template_id=:task_template_id and data_index=:data_index and file_status=:file_status";
        redisPreparedStatement.prepare(sql);
        redisPreparedStatement.setString(1, String.valueOf(task_template_id));
        redisPreparedStatement.setString(2, String.valueOf(data_index));
        redisPreparedStatement.setString(3, "1");
...
//                logger.info("ColumnLabel：{}，value：{}", rsMeta.getColumnLabel(i + 1), value);
    ...
    public void update() throws Exception {
        ...
        redisPreparedStatement.setString(1, "2");
